 ...
 */
final class Version20240825173124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message ADD reponse_a_id INT DEFAULT NULL, CHANGE date_message date_message DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE INDEX IDX_B6BD307F7B51A1B ON message (reponse_a_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY FK_B6BD307FFB88E14F');
        $this->addSql('DROP INDEX IDX_B6BD307F7B51A1B ON message');
        $this->addSql('ALTER TABLE message DROP reponse_a_id, CHANGE date_message date_message DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
